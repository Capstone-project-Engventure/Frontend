// src\lib\store\adminGrammarStore.ts
import { Lesson } from "@/lib/types/lesson";
import { create } from 'zustand';
import { persist } from 'zustand/middleware';

interface AdminGrammarState {
    lessons: Lesson[];
    hasFetched: boolean;
    hasHydrated: boolean;
...
const useAdminGrammarStore = create<AdminGrammarState>()(
    persist(
        (set, get) => ({
            lessons: [],
            hasFetched: false,
...
export default useAdminGrammarStore; 