...
export default function ListeningPractice() {
  ...
  const [lessonsByTopic, setLessonsByTopic] = useState<OptionProps[]>([]);
  ...
  useEffect(() => {
    ...
    const fetchLessonByTopic = async () => {
      try {
        const res = await lessonService.getAllByTopic(selectedTopic.key);
  ...
  return (
    <div className="min-h-screen flex flex-col p-4 bg-white text-gray-800">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="text-red-500 text-xl">❤️ {user?.heart}</div>
      </div>
