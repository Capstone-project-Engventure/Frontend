...
import grammarPracticeService from "@/lib/services/grammar-practice.service";
...
const GrammarPractice: React.FC = () => {
    ...
    const breadcrumbs = [
        ...
        { label: t("breadcrumbs.grammarPractice"), href: `/${locale}/student/practice/grammar` },
    ];
    ...
    useEffect(() => {
        ...
        fetchLessons();
    }, [hasHydrated, hasFetched, lessons, setHasFetched, setLessons]);
