...
export default function ImportModal({ isOpen, onClose, onHandleFile }) {
  ...
  const handleFileRead = async (file) => {
    ...
    reader.onload = async (e) => {
      try {
        ...
        onHandleFile(file); // You define this in parent
              ...
              <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 shadow-xl transition-all">
                ...
                <div className="mt-6 flex justify-end gap-2">
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (selectedFile) handleFileRead(selectedFile);
                      else setError("Vui lòng chọn file trước khi nhập.");
                    }}
                  >
                    Nhập file
                  </button>
